...
Hey there, I’m Krypton! (Coming from the [Krypton element](https://en.wikipedia.org/wiki/Krypton) 36 ⚛️) I’m a cloud engineer, developer, security researcher and overall security enthusiast. I like computers *(surprised?)* and anything related to cyber security, especially information gathering and reverse engineering.
...
- [Investigating a music player app that claims to scan against viruses](https://krypton.ninja/blog/investigating-a-music-player-app-that-claims-to-scan-against-viruses)
